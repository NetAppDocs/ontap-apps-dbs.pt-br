...
[NOTE]
====
* Em bancos de dados Oracle, o NVFAIL deve ser habilitado em todos os LUNs que hospedam componentes críticos (datafiles, redo logs, control files).
* Em sistemas AFF, o NVFAIL opera na camada de volume e se aplica a todos os dados contidos.
* No ASA, o NVFAIL opera na camada LUN ou de namespace.
