...
summary: Oracle,SM-as,sincronização ativa,mediador 
searchtitle: Oracle, SnapMirror ative Sync e o Mediador ONTAP 
---
= ONTAP Mediador
:allow-uri-read: 
:imagesdir: ../media/
...
image:smas-mediator.png["Diagrama de sincronização ativa do SnapMirror com mediador"]
