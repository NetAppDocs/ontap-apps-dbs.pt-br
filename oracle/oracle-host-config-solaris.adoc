...
. Particione os LUNs e verifique se estão alinhados corretamente. Consulte link:oracle-notes-wafl-alignment-verification.html["Alinhamento WAFL"] as instruções sobre como testar e confirmar o alinhamento diretamente.
