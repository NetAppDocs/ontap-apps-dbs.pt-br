...
summary: Recuperação automática do Oracle sem modo de backup. 
searchtitle: Recuperação automática do Oracle sem modo de backup. 
---
...
. Executar `alter database automatic;`
