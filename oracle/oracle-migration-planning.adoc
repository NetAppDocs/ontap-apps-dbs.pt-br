...
Por exemplo, copiar um banco de dados de 10 TB normalmente requer aproximadamente sete horas para ser concluído. Se as necessidades da empresa permitirem uma interrupção de sete horas, a cópia de arquivos é uma opção fácil e segura para a migração. Se cinco horas forem inaceitáveis, um processo simples de envio de logs (consulte link:oracle-migration-log-shipping.html["Oracle log de envio"]) pode ser configurado com o mínimo de esforço para reduzir o tempo de transição para aproximadamente 15 minutos. Durante esse período, um administrador de banco de dados pode concluir o processo. Se 15 minutos forem inaceitáveis, o processo final de transição pode ser automatizado por meio de scripts para reduzir o tempo de transição para apenas alguns minutos. Você sempre pode acelerar uma migração, mas isso tem um custo em tempo e esforço. As metas de tempo de transição devem ser baseadas no que é aceitável para a empresa.
