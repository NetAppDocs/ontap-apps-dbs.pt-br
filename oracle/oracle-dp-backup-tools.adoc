...
[role="lead"]
O principal valor do ONTAP em um ambiente de banco de dados Oracle vem das tecnologias essenciais do ONTAP, como cópias instantâneas de Snapshot, replicação simples com SnapMirror e criação eficiente de volumes clonados, LUNs e namespaces.
