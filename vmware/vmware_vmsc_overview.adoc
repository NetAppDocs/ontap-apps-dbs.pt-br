...
Para obter mais informações sobre as vantagens do design e implantação simétricos ou assimétricos, consulte o https://docs.netapp.com/us-en/ontap/smbc/index.html["Documentação de sincronização ativa do SnapMirror"].
