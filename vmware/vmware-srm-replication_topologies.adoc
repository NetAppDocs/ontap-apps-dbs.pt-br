...
Para obter as informações mais recentes sobre o SnapMirror e o SnapVault para ONTAP 9, consulte https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["TR-4015 Guia de práticas recomendadas de configuração do SnapMirror para ONTAP 9."^]
