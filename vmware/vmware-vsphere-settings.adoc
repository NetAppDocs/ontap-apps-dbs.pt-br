...
Aqui estão as configurações de host atualmente recomendadas com as versões 9,8-9,13.
...
| VMFS3.EnableBlockDelete | Mantenha o padrão (0), mas pode ser alterado se necessário. Para obter mais informações, consulte link:https://knowledge.broadcom.com/external/article?legacyId=2007427["VMware KB 2007427"] | Não 
