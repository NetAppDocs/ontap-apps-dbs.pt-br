...
NOTE: vVols requer o uso das ONTAP tools for VMware vSphere, que funcionam como o VASA Provider para ONTAP. Consulte link:vmware-vvols-overview.html["VMware vSphere Virtual volumes (vVols) com o ONTAP"] para as melhores práticas de vVols.
