...
Para obter mais informações sobre snapshots, consulte a documentação do ONTAP . Os links a seguir fornecem detalhes adicionais: https://docs.netapp.com/us-en/ontap/data-protection/manage-local-snapshot-copies-concept.html["Cópias Snapshot locais do ONTAP"^] https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-replication-workflow-concept.html["Fluxo de trabalho de replicação do ONTAP SnapMirror"^]
