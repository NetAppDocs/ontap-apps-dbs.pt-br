...
O ONTAP fornece recursos de eficiência de storage da NetApp, como a tecnologia NetApp Snapshot(R), clonagem, deduplicação, thin Provisioning, thin replication, compactação, disposição em camadas de storage virtual e muito mais, com performance e eficiência aprimoradas.
